  ...
  <div class="card">
    <div class="card-body" style="background-color: #0A043E">
    	...
    	<h3 class="text-center wht">BANK WITHDRAWAL POSTING</h3>
    	...
    	<form method="POST" id="mydepositform" action="{{ url('bankW') }}" autocomplete="off">
			@csrf
    		
    		<div class="form-group row">
    			<div class="col-md-4"></div>
    			<div class="col-md-4">
    			<input type="text" name="nuban11" id="nuban11" placeholder="Account Number" class="form-control myedit" onkeyup="deposit1()" onmouseout="deposit1()">
    		...
    		<div class="col-md-6" >
    			<input type="text" id="displaybal" placeholder="Balance" readonly="readonly" class="form-control myedit" >
    		</div>
